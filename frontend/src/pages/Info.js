          ...
          <div className="mt-[2%] flex flex-col gap-4">
            ...
            <div className="w-[50%]">
              ...
              <div className="text-[#9AA3A6] font-Poppins max-[1024px]:text-sm">
                We collect minimal user data for app functionality, prioritize
                security, do not sell personal information, and users have
                rights to access, update, or delete their data.
              </div>
            </div>
            <div className="w-[50%]">
              <div className="font-Poppins max-[1024px]:text-sm font-bold">
              ...
              <div className="text-[#9AA3A6] font-Poppins">
                <div className="max-[1024px]:text-sm">P: +91 7827328869</div>
                <div className="max-[1024px]:text-sm">
                  E: samarjitmahi6245@gmail.com
                </div>
              </div>
            </div>
          </div>
