    ...
    <div className="h-[100vh] px-40 max-[885px]:px-20 max-[653px]:px-14 py-[5%] flex justify-center items-center">
      <div className="flex flex-col items-center">
        ...
        <div className=" mt-[10%] w-[70vw] max-[653px]:gap-4 grid grid-cols-1 place-items-center sm:grid-cols-2 gap-10">
          <Card
            title="Simple"
            description="With intuitive interface,zapgram is so simple you already know how to use it"
          ></Card>
          <Card
            title="Synced"
            description="zapgram lets you acess your chats. Keeping it secured in databases"
          ></Card>
          <Card
            title="Private"
            description="zapgram messages are heavily encrypted and can self-destruct"
          ></Card>
          <Card
            title="Secure"
            description="zapgram keeps your messages safe from hacker attacks"
          ></Card>
        </div>
      </div>
    </div>
